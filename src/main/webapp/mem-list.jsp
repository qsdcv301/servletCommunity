<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="kdtweb.beans.User, java.util.*, java.sql.*"%>
<%@ include file="include/header.jsp"%>
<jsp:useBean id="memlist" class="kdtweb.dao.members.SelectMem"
	scope="page" />
<%
			...
			<table class="table table-bordered memtable">
				...
				<tbody>
					...
					<tr>
						...
						<td><%=user.getRdate()%></td>
						<td><select class="editlevel" data-id="<%=user.getUserid()%>">
...
<script>
	...
	$(function() {
		$(document).on("change", ".editlevel", function() {
			const lv = $(this).val();
